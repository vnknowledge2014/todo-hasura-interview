...
export const descriptionInsertFieldAuditLogMock = "{\"user_id\":\"bf4481bc-4883-41b2-ab5e-5deca59c79a1\",\"operation\":\"INSERT\",\"event\":\"todo_item_added\",\"table\":\"todo\",\"updated_at\":\"2021-11-21T12:09:50.416966+00:00\",\"insert_field\":{\"id\":\"d06ed8cf-051c-4e23-9210-a0f18e336ec5\",\"title\":\"test\",\"completed\":false}}";

export const eventTodoItemAddedMock = {
    event: {
...
export const eventTodoItemUpdatedMock = {
    "event": {
        "session_variables": {
            "x-hasura-role": "admin"
        },
...
export const eventTodoItemEmptyMock = {};
